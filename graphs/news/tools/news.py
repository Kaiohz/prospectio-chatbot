...
class NewsTools:
    ...
    async def get_top_headlines(question: str,country_code: str) -> Tuple[List[str], List[str]]:
        ...
        try:
            sources_response = []
            if country_code:
                sources_response: SourcesResponse = await GoogleNewsApi.get_top_headlines_sources(country_code.lower())
        ...
        try:
            ...
            duck_duck_descriptions = [result["snippet"] for result in duck_duck_response]
